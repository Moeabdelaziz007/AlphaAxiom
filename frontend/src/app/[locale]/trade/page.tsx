...
export default function TradePage() {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            <div className="hidden border-b border-gray-800 flex justify-between items-center p-6">
                <div>
                    <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Trading Terminal</h1>
                    <p className="text-gray-500 text-sm">Execute trades with precision</p>
                </div>
            </div>
